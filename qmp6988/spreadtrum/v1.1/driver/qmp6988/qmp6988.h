...
#define PRESS_IOCTL_SET_ENABLE             _IOW(0x87, 0, int)
#define PRESS_IOCTL_SET_DELAY              _IOW(0x87, 1, int)
#define PRESS_IOCTL_GET_CALI               _IOR(0x87, 2, struct qmp6988_calibration_data)
#define PRESS_IOCTL_GET_RAW_DATA           _IOR(0x87, 3, int[2])
