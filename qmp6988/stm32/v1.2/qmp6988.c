...
u8 qmp6988_WriteReg(u8 slave, u8 reg_add,u8 reg_dat)
{
...
#else
	I2C_Bus_set_slave_addr(slave);
	return I2C_ByteWrite(reg_dat,reg_add); 
#endif
}

u8 qmp6988_ReadData(u8 slave, u8 reg_add,unsigned char* Read,u8 num)
{
#if 0//defined(QST_USE_SPI)
...
static u8 qmp6988_device_check(qmp6988_data *qmp6988)
{
	u8 slave_addr[2] = {QMP6988_SLAVE_ADDRESS_L, QMP6988_SLAVE_ADDRESS_H};
	u8 ret = 0;
	u8 i;
...
u8 qmp6988_init(qmp6988_data *qmp6988)
{
	u8 ret;
