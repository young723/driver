...
ifeq ($(CFG_QMP6988_SUPPORT),yes)
C_FILES  += $(SENDRV_DIR)/barometer/qmp6988.c
endif
endif
...
ifeq ($(CFG_AKM_ALGO_ALLINONE_SUPPORT),yes)
C_FILES  += $(SENLIB_DIR)/akl_allinone/AKM_DataSort.c
C_FILES  += $(SENLIB_DIR)/akl_allinone/Platform/akm_wrapper.c
C_FILES  += $(SENLIB_DIR)/akl_allinone/Platform/FileIO.c
C_FILES  += $(SENLIB_DIR)/akl_allinone/AKM_Library/akm_apis.c
C_FILES  += $(SENLIB_DIR)/akl_allinone/AKM_Library/akl_apis.c
C_FILES  += $(SENLIB_DIR)/akl_allinone/AKM_Library/akl_lib_interface.c
C_FILES  += $(SENLIB_DIR)/akl_allinone/AKM_Library/akl_measure.c
...
LIBFLAGS += -L$(SENLIB_DIR)/akl_allinone/AKM_Library/libSmartCompass -lakm

else
ifeq ($(CFG_FAST_CALIBRATION_SUPPORT),yes)
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/libag/akl_apis.c
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/libag/measure.c
INCLUDES += -I$(SENLIB_DIR)/akl/AKM_Library/libag
else
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/lib9d/akl_apis.c
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/lib9d/measure.c
INCLUDES += -I$(SENLIB_DIR)/akl/AKM_Library/lib9d
endif

ifeq ($(CFG_VIRTUAL_GYRO_SUPPORT),yes)
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/libpg/akm_pg_wrapper.c
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/libpg/AKMPG_APIs.c
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/libpg/AKMPG_MeasureF.c
INCLUDES += -I$(SENLIB_DIR)/akl/AKM_Library/libpg
endif

C_FILES  += $(SENLIB_DIR)/akl/akm_wrapper.c
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/akm_apis.c
C_FILES  += $(SENLIB_DIR)/akl/AKM_Library/common/akl_nonos_ext.c

INCLUDES += -I$(SENLIB_DIR)/akl/
INCLUDES += -I$(SENLIB_DIR)/akl/Platform
INCLUDES += -I$(SENLIB_DIR)/akl/AKM_Library
INCLUDES += -I$(SENLIB_DIR)/akl/AKM_Library/libSmartCompass

LIBFLAGS += -L$(SENLIB_DIR)/akl/AKM_Library/libSmartCompass -lakm
endif
endif
...
LIBFLAGS += -L$(SENLIB_DIR)/mmc3530 -lMagCaliAlgo
endif
