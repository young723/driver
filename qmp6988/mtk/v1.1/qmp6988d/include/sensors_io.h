...
struct qmp6988_calibration_data {
	...
	signed short COE_a2;
	signed int COE_b00;
	signed short COE_bt1;
	signed short COE_bt2;
	signed short COE_bp1;
	signed short COE_b11;
	signed short COE_bp2;
	signed short COE_b12;
	signed short COE_b21;
	signed short COE_bp3;
};
...
#define GSENSOR_QST_IOCTL_STEP_RESET           _IO(GSENSOR,  0x14)
...
#define COMPAT_GSENSOR_QST_IOCTL_STEP_RESET           _IO(GSENSOR,  0x14)
...
#define COMPAT_BAROMETER_GET_PRESS_RAW_DATA		_IOR(BROMETER, 0x05, compat_int_t)
#define COMPAT_BAROMETER_GET_TEMP_RAW_DATA			_IOR(BROMETER, 0x06, compat_int_t)
#endif
