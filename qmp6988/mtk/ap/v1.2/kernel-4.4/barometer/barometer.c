...
#if defined(QMP6988_GET_DATA_2)
	if(cxt->baro_data.get_data_2)	// add by yangzhiqiang
		err = cxt->baro_data.get_data_2(&value, &value2, &status);
	else
#endif
...
#if defined(QMP6988_GET_DATA_2)
			cxt->drv_data.baro_data.values[1] = value2;		// add by yangzhiqiang
#endif
...
#if defined(QMP6988_GET_DATA_2)
	// add by yangzhiqiang
	cxt->baro_data.get_data_2 = data->get_data_2;
	// add by yangzhiqiang
#endif
...
#if defined(QMP6988_GET_DATA_2)
	// add by yangzhiqiang
	if(baro_context_obj->baro_data.get_data_2)
	{
		event.word[1] = baro_context_obj->drv_data.baro_data.values[1];
	}
	// add by yangzhiqiang
#endif
	event.status = status;
