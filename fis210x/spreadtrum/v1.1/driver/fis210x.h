...
//#define BUILD_ON_MTK_KK
#define BUILD_ON_SPREADTRUM

#define DEBUG
#ifdef DEBUG
#define FIS210X_TAG				        "[FIS210X] "
#define FIS210X_FUN( )			        printk(KERN_INFO FIS210X_TAG"%s\n", __FUNCTION__)
#define FIS210X_LOG(fmt, args...)		printk(KERN_INFO FIS210X_TAG fmt, ##args)
#define FIS210X_ERR(fmt, args...)		printk(KERN_ERR  FIS210X_TAG"%s %d : "fmt, __FUNCTION__, __LINE__, ##args)
#else
#define LOG_TAG				       
#define FIS210X_FUN( )			        
...
#define ABSMIN_GYRO							(-2000)
#define ABSMAX_GYRO							(2000)

#define FIS210X_MAX_DELAY					2000

#define FIS210X_ATTR_WR						0666
#define FIS210X_ATTR_R						0444
#define FIS210X_ATTR_W						0222
...
#define FISIMU_CTRL7_DISABLE_ALL 			0x00
#define FISIMU_CTRL7_ACC_ENABLE 			0x01
#define FISIMU_CTRL7_GYR_ENABLE				0x02
#define FISIMU_CTRL7_MAG_ENABLE				0x04
#define FISIMU_CTRL7_AE_ENABLE				0x08
#define FISIMU_CTRL7_ENABLE_MASK			0x0F
