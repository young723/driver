...
#define AKMDBG_D9D          (DATA_AREA06) /*<! Direction9D */
...
#define AKMDBG_ROV          (DATA_AREA12) /*<! Rotation Vector */

#ifndef AKMD_DISABLE_DOEPLUS
#define AKMDBG_DOEPLUS      (DATA_AREA13) /*<! DOEPlus */
#endif

//#define AKMDBG_DOEAG        (DATA_AREA14) /*<! DOEaG */
