...
#define AKM_LIBRARY_FOOTPRINT   "20171219"
...
typedef enum {
    ...
    /*! TBD */
    /* defined for fusion */
    AKM_ST_FUSION_ACC = 0x100,
    AKM_ST_FUSION_MAG = 0x200,
    AKM_ST_FUSION_GYR = 0x400,
...
typedef enum {
    ...
    //GYR|ORI|GRAVITY|LACC|QUAT
    AKM_VT_OUTPUT9D = 0x7c,
} AKM_VECTOR_TYPE;
...
struct AKM_SENSOR_DATA {
    ...
    int64_t time_stamp;
    /*!
     * This field is used to store device id value.
     * for multi library it is used for CRC check */
    uint8_t device_id;
    /*!
     * This field is used to store pat value.
     * for multi library it is used for CRC check */
    uint8_t pat;
    /*!
