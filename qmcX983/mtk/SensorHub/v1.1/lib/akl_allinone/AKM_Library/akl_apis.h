...
enum{
    AKL_MODE_CALIB_DOE        = 0x01,
    AKL_MODE_CALIB_DOEEX      = 0x02,
    AKL_MODE_CALIB_DOEAG      = 0x04,
    AKL_MODE_FUSION_CLOSE     = 0x10,
    AKL_MODE_FUSION_6D_PG_ON  = 0x20,
    AKL_MODE_FUSION_6D_PG_OFF = 0x40,
    AKL_MODE_FUSION_9D        = 0x80,
    AKL_MODE_FUSION_OUTPUT9D  = 0xa0, //=AKL_MODE_FUSION_9D|AKL_MODE_FUSION_6D_PG_ON
};
