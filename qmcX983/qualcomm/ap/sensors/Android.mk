...
include $(CLEAR_VARS)
LOCAL_PREBUILT_LIBS := algo/qmcX983/ical.a
LOCAL_MODULE := libcalmodule_qmcX983
LOCAL_C_INCLUDES += $(LOCAL_PATH)/algo/qmcX983
LOCAL_SRC_FILES := algo/qmcX983/qmcX983_wrapper.c
