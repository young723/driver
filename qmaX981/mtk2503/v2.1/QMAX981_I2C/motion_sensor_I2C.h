...
//#define USE_QST_SW_IIC

#define QMAX981_SLAVEADDR_0			0x24
#define QMAX981_SLAVEADDR_1			0x26
...
extern kal_uint8 i2c_CheckDevice(kal_uint8 _Address);
extern kal_uint8 qst_sw_writereg(kal_uint8 slave, kal_uint8 reg_add, kal_uint8 reg_dat);
extern kal_uint8 qst_sw_readreg(kal_uint8 slave, kal_uint8 reg_add, kal_uint8 *buf, kal_uint8 num);
#endif

#if defined(USE_MTK_SW_IIC)
extern kal_bool qst_write_byte(kal_uint8 slave_addr, kal_uint8 RegAddr, kal_uint8 Data);
extern kal_bool qst_read_bytes(kal_uint8 slave_addr, kal_uint8 RegAddr, kal_uint8* Data, kal_uint32 Length);
#endif
