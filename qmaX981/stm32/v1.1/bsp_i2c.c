...
static uint8_t i2c1_slave_address = 0x00;
...
uint8_t I2C_ByteWrite(u8 pBuffer, u8 WriteAddr)
{
  ...
  I2C_Send7bitAddress(SENSORS_I2Cx, i2c1_slave_address, I2C_Direction_Transmitter);
...
{  
  ...
  I2C_Send7bitAddress(SENSORS_I2Cx, i2c1_slave_address, I2C_Direction_Receiver);
