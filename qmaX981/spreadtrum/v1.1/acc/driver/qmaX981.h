...
#if 0
#define QMAX981_ATTR_WR		S_IRUGO | S_IWUSR
#define QMAX981_ATTR_R		S_IRUGO
#define QMAX981_ATTR_W		S_IWUSR
#else
#define QMAX981_ATTR_WR		444 | 200
#define QMAX981_ATTR_R		444
#define QMAX981_ATTR_W		200
#endif
